...
class calculator extends JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e)
    {
        ...
        if ((s.charAt(0) >= '0' && s.charAt(0) <= '9') || s.charAt(0) == '.') {
            ...
            if (s1.equals("+"))
                te = performAddition(s0, s2);
            else if (s1.equals("-"))
                te = performSubstraction(s0, s2);
            else if (s1.equals("/"))
                te = performDivision(s0, s2);
            else
                te = performMultiplication(s0, s2);
    ...
    public Double performSubstraction(String x, String y){
        Double result =  (Double.parseDouble(x) - Double.parseDouble(y));
        return result;
    }
